...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:Ui,depthTest:!1,depthWrite:!1})}function dp(){return new Hi({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:Qu(),fragmentShader:`
		...
		`,blending:Ui,depthTest:!1,depthWrite:!1})}function hp(){return new Hi({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:Qu(),fragmentShader:`
